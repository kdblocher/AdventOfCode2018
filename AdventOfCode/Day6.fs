...
let maxArea coords =
  let (coords, array, areas, lengthX, lengthY) =
    ...
    let array = Array.init lengthX (fun _ -> Array.zeroCreate<Location option> lengthY)
    ...
    (coords, array, areas, lengthX, lengthY)
